  ...
  return (
    <>
      <Head>
        ...
        <link
          href="/icons/JR_16.png"
          rel="icon"
          type="image/png"
          sizes="16x16"
        />
        <link
          href="/icons/JR_32.png"
          rel="icon"
          type="image/png"
          sizes="32x32"
        />
        <link rel="apple-touch-icon" href="/icons/JR_16.png"></link>
        <link rel="apple-touch-icon" href="/icons/JR_32.png"></link>
      </Head>
      <Component {...pageProps} />
    </>
  );
