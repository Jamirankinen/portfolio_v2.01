...
const WindowImage = ({ src }) => (
  <HoverImage showFilter imageClassName="mk-image" src={src} />
);
    ...
    <div className="mk-projects-single">
      <div className="row">
        <div className="col-6 d-none d-lg-block">
          <div className="">
            <WindowScreen
              containerClassName={`mk-projects-image-container mk-projects-image-container-${side}`}
            >
...
const ProjectTextSide = (props) => {
  ...
  return (
    ...
    >
      <div data-aos={`zoom-in-${side}`} className="mk-projects-text-featured">
        {label}
      </div>
      <div data-aos={`zoom-in-${side}`} className="mk-projects-text-title">
        {title}
      </div>
      <div
      ...
      <div data-aos={`zoom-in-${side}`} className="mk-projects-text-tecs">
        {techs.map(
